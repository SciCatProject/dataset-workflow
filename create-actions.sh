...
wsk -i action update mantid-reduce-dataset ./src/actions/mantid_reduce_dataset.py -P config.local.json -m 1024 --docker dacat/openwhisk-python2action-mantid:latest
